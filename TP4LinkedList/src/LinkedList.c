...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this != NULL && nodeIndex > -1 && nodeIndex <= ll_len(this)) //&& nodeIndex < ll_len(this) no entra al if
    {
        //printf("nodeindex = %d y ll_len = %d\n", nodeIndex, ll_len(this));
        ...
        if(nodeIndex == 0)
        {
            ...
            {
                //printf("1-nodeindex = %d y ll_len = %d\n", nodeIndex, ll_len(this));
                this->pFirstNode = nuevoNodo;
            }
            else
            {
                //printf("1.5-nodeindex = %d y ll_len = %d\n", nodeIndex, ll_len(this));
...
//  ******* OJO CORREGIR *******************
/** \brief Devuelve el elemento de la linkedlist del indice selecionado
 *
 * \param this LinkedList* Puntero a la lista
...
void* ll_get(LinkedList* this, int index)
{
    ...
    {
        nPedido = getNode(this, index);
        if(nPedido->pElement != NULL)
        {
            returnAux = nPedido->pElement;
        }
    }
